  ...
  <>
   <div className="relative z-50">
    <motion.div
     ...
     className="fixed left-1/2 top-0 h-[4.5rem] w-full rounded-none border border-white border-opacity-40 bg-white bg-opacity-80 shadow-lg shadow-black/[0.03] backdrop-blur-[0.5rem] dark:border-black/40 dark:bg-gray-950 dark:bg-opacity-75 sm:top-6 sm:h-[3.25rem] sm:w-[39rem] sm:rounded-full"
    ></motion.div>
   </div>
      ...
      >
       <Link
        className={cn(
         ...
         link.hash === "#home" ? "font-lmroman italic" : "",
        )}
        href={link.hash}
        onClick={(e) => {
         e.preventDefault();
